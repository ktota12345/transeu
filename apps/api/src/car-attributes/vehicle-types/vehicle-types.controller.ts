...
export class VehicleTypesController {
    ...
    @Post()
    create(@Body() dto: Prisma.VehicleTypeCreateInput) {
    ...
    async list(
        ...
        res.setHeader('Content-Range', `vehicle-types ${skip}-${skip + items.length - 1}/${total}`);
    ...
    @Put(':id')
    update(@Param('id') id: string, @Body() dto: Prisma.VehicleTypeUpdateInput) {
