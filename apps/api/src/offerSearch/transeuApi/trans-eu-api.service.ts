...
export class TransEuApiService {
    ...
    private readonly MIN_DISTANCE = 200000; // 200 km
    private readonly MAX_DISTANCE = 3000000; // 1000 km

    private getBearerToken(): string {
        //return "Bearer " + process.env.TRANSEU_BEARER_TOKEN;
    ...
    async fetchOffers(searchParams: any): Promise<any> {
        ...
        console.log(searchParams.startLocation);
